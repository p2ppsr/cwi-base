...
export class CwiError implements CwiErrorApi {
  ...
  static fromUnknown (err: unknown): CwiError {
    ...
    if (err && typeof err === 'object') {
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      const e = err as { code?: any, status?: any, description?: any, message?: any, toString?: any, stack?: any, sql?: any, sqlMessage?: any }
      code = e.code || e.status || code
      description = e.description || e.message || description
      if (!description && e.toString && typeof e.toString === 'function') { description = e.toString() }
      if (e.stack && typeof e.stack === 'string') { stack = e.stack }
