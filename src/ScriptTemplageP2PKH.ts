import { LockingScript, OP, PrivateKey, Script, ScriptTemplate, Transaction, TransactionSignature, UnlockingScript } from "@bsv/sdk"
 ...
 */
export default class ScriptTemplateP2PKH implements ScriptTemplate {
  /**
